                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="copyright text-left">
                            <p class="copyright">&copy; 2022 <strong>Lecore Plywood</strong> Made with <i class="fa fa-heart text-danger" aria-hidden="true"></i> by <a href="www.cryptina.in"><strong>CRYPTINA INDIA</strong></a>.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
...
<!-- Mirrored from demo.hasthemes.com/Lecore Plywood-preview/Lecore Plywood/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 19:54:07 GMT -->
</html>